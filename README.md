...
Of course, it is important to note, that these blockchain improvements are only as good as the underlying contacts. There is still potential for fraud from the contact owners and cheating from hackers. Additionally, there is a concern of waste through gas consumption. These and other issues need to be addressed to a satisfactory degree the contract. 
